    ...
    <main className="container">
      <div className="card">
        <div className="noPrint" style={{marginBottom:20}}>
          ...
          <p className="desc">
            계약서가 정상 제출되었습니다. PDF는 Google Drive에 자동 저장되었습니다.
          </p>
          <div style={{display:"flex", gap:10, flexWrap:"wrap"}}>
            {pdfUrl ? (
              <a className="btn" href={pdfUrl} target="_blank" rel="noopener noreferrer">Google Drive PDF 열기</a>
            ) : (
              <button className="btn" disabled>PDF 링크 생성 중 또는 관리자 Drive에서 확인</button>
            )}
